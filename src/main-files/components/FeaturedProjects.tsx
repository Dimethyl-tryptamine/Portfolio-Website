...
const FeaturedProjects = () => {
    ...
    return (
        <div className='bg-secondary pb-6 border-solid border-primary p-[.5rem] rounded-[1rem] border-[.1rem] flex flex-col mb-[2rem] h-auto shadow-[0px_0px_5px_1px_rgba(136,0,255,0.8)] overflow-hidden'>
            ...
            <button onClick={handleClick} className={` med:hidden flex bg-[#141414] ${isOpen ? 'rotate-90' : ''}  w-min ml-auto transform transition-transform duration-300 ease-in-out rounded-md border mt-3 border-[#8800ff] p-[.3rem] shadow-[0px_0px_5px_1px_rgba(136,0,255,0.8)]`}>
            ...
            <motion.div className="grid grid-cols-1 gap-1 med:grid-cols-4 sml:grid-cols-2 mt-4" variants={boxVariants} initial="closed" animate={isOpen ? "open" : "closed"}>
