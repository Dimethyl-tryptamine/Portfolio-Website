                    ...
                    <a href="https://search-project-wastaken.netlify.app/" target="_blank" rel="noopener noreferrer">
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="m-2 rounded-lg w-full p-2">
                                ...
                                <p className=" hidden xxs:flex sml:hidden  med:flex text-xs text-left">A search and filtering web application built with Next.js, TypeScript, and Axios. Features include: Text-based search across items Tag-based filtering Range input filters Dynamic fetching via API routes Clean project structure with TypeScript types, and param and url query implementation</p>
                            </div>
                            </div>
